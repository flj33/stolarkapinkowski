...
const stats = [
  ...
  { icon: Award, value: "100%", label: "Zaangażowania" },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Nazywam się Marcin Pińkowski. Posiadam wykształcenie zawodowe w kierunku technik technologii drewna oraz 
            ...
            <div className="space-y-4">
              {[
                "Układanie podłóg drewnianych, paneli i winylowych",
                "Montaż drzwi wewnętrznych i zewnętrznych",
                "Budowa tarasów i podestów drewnianych",
                "Montaż okien, rolet i osłon przeciwsłonecznych"
              ].map((item) => (
