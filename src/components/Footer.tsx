        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <span className="font-bold block text-sm sm:text-base">Marcin Pińkowski</span>
                <span className="text-xs sm:text-sm text-muted-foreground">Usługi Budowlane</span>
              </div>
            </div>
            <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed">
              Profesjonalne usługi montażowe: podłogi, drzwi, tarasy i inne prace wykończeniowe. Ponad 25 lat doświadczenia w branży.
            </p>
          </div>

          <div>
            <h4 className="font-bold mb-3 sm:mb-4 text-sm sm:text-base">Usługi</h4>
          ...
          <div>
            <h4 className="font-bold mb-3 sm:mb-4 text-sm sm:text-base">Kontakt</h4>
