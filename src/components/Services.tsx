  ...
  return (
    <section id="uslugi" className="section-padding bg-secondary/30">
      <div className="container mx-auto px-5 sm:px-6">
        ...
        <div 
          ref={cardsRef}
          className={`grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 transition-all duration-700 delay-200 ${
              ...
              <CardContent className="pt-0">
                <ul className="space-y-2">
                  {service.items.map((item) => (
                    <li key={item} className="flex items-center text-sm sm:text-base text-foreground/80">
        ...
        >
          ...
          <p className="text-muted-foreground mb-6 max-w-xl mx-auto text-base leading-relaxed">
